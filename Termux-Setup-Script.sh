            ...
            1)
                ...
                apk_editor_loop() {
                    ...
                    if [ ! -f "/storage/emulated/0/Shite/APKEditor.jar" ]; then
                        echo -e "${BLUE}[*] Downloading APKEditor v1.4.7...${RESET}"
                        mkdir -p "$HOME/temp_downloads"
                        cd "$HOME/temp_downloads"
                        if wget -q https://github.com/REandroid/APKEditor/releases/download/V1.4.7/APKEditor-1.4.7.jar; then
                            mkdir -p /storage/emulated/0/Shite
                            mv APKEditor-1.4.7.jar /storage/emulated/0/Shite/APKEditor.jar
                        else
